...
var averageAgeMale = average(ancestry.filter(male).map(age));
var averageAgeFemale = average(ancestry.filter(female).map(age));

console.log("averageAgeMale:", averageAgeMale);
console.log("averageAgeFemale:", averageAgeFemale);
